...
plt.tight_layout()
plt.savefig("reports/epv_categoria_severidade.png")
...
plt.tight_layout()
plt.savefig("reports/epv_por_severidade.png")
...
plt.tight_layout()
plt.savefig("reports/epv_por_categoria.png")
...
plt.tight_layout()
plt.savefig("reports/epv_total_completo.png")
