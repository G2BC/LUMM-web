...
export const contributors = [
  ...
  },
  {
    ...
    bio: {
      ...
      en: "Full-stack software developer and undergraduate student in Information Systems at the State University of Bahia (UNEB). Works professionally on the development of web applications and APIs, with experience in JavaScript/TypeScript, React/Node, and Python/Django, as well as integrations and microservices architecture; also has prior experience as a tutor/teaching assistant in full-stack training. In the academic domain, contributes to LUMM, a web database dedicated to the scientific dissemination of bioluminescent fungi, and pursues work in software engineering applied to bioinformatics, with an emphasis on the security of Docker-containerized web applications.",
    },
    links: [
      {
        icon: <Mail className="w-5 h-5" />,
