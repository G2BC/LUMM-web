...
export const contributors: Contributor[] = [
  ...
  },
  {
    ...
    bio: {
      pt: "Desenvolvedor de software full stack e graduando em Sistemas de Informação pela Universidade do Estado da Bahia (UNEB). Atua no desenvolvimento de aplicações web e APIs, com experiência em JavaScript/TypeScript, React, Node.js, Python/Django, integrações entre sistemas e arquitetura de software. No contexto acadêmico, contribui para o LUMM — Luminescent Mushrooms, banco de dados web voltado à divulgação científica sobre fungos luminescentes, e para o BEM — Brazilian Edible Mushrooms, plataforma dedicada à documentação e divulgação científica de cogumelos comestíveis do Brasil. Tem interesse em engenharia de software aplicada à bioinformática, ciência de dados e segurança de aplicações web conteinerizadas.",
      en: "Full-stack software developer and undergraduate student in Information Systems at the State University of Bahia (UNEB). Works on the development of web applications and APIs, with experience in JavaScript/TypeScript, React, Node.js, Python/Django, system integrations, and software architecture. In the academic context, contributes to LUMM — Luminescent Mushrooms, a web database focused on scientific communication about luminescent fungi, and to BEM — Brazilian Edible Mushrooms, a platform dedicated to documenting and disseminating scientific information about edible mushrooms from Brazil. Interested in software engineering applied to bioinformatics, data science, and the security of containerized web applications.",
    },
    links: [
      {
        icon: <Mail className="w-5 h-5" />,
